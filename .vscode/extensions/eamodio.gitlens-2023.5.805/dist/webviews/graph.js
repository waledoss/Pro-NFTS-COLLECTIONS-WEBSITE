...
`;let Pl=class extends Rt{constructor(){super(...arguments),this.open=!1,this.isTrackingOutside=!1}get triggerNode(){if(_l(this.triggerNodes))return this.triggerNodes[0]}get contentNode(){if(_l(this.contentNodes))return this.contentNodes[0]}connectedCallback(){super.connectedCallback(),this.updateToggle(),this.addEventListener("click",this.handleToggle.bind(this),!1)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleToggle.bind(this),!1),this.disposeTrackOutside()}handleToggle(e){e.composedPath().includes(this.triggerNode)&&(this.open=!this.open,this.updateToggle())}updateToggle(){null!=this.triggerNode&&(this.triggerNode.ariaExpanded=this.open.toString()),this.open&&(null!=this.contentNode&&window.requestAnimationFrame((()=>{this.contentNode?.focus()})),this.trackOutside())}handleDocumentEvent(e){if(!1===this.open)return;e.composedPath().includes(this)||(this.open=!1,this.disposeTrackOutside())}trackOutside(){if(this.isTrackingOutside||!this.open)return;this.isTrackingOutside=!0;const e=this.handleDocumentEvent.bind(this);document.addEventListener("click",e,!1),document.addEventListener("focusin",e,!1)}disposeTrackOutside(){if(!this.isTrackingOutside)return;this.isTrackingOutside=!1;const e=this.handleDocumentEvent.bind(this);document.removeEventListener("click",e,!1),window.removeEventListener("focusin",e,!1)}};Ol([gt({mode:"boolean"})],Pl.prototype,"open",2),Ol([Je],Pl.prototype,"triggerNodes",2),Ol([Je],Pl.prototype,"contentNodes",2),Ol([et],Pl.prototype,"triggerNode",1),Ol([et],Pl.prototype,"contentNode",1),Pl=Ol([Et({name:"pop-menu",template:Il,styles:Ml})],Pl);const Al=Qa(Pl);var Dl=Object.defineProperty,Nl=Object.getOwnPropertyDescriptor,$l=(e,t,n,o)=>{for(var r,i=o>1?void 0:o?Nl(t,n):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(o?r(t,n,i):r(i))||i);return o&&i&&Dl(t,n,i),i};const zl=Jn`
	<template>
