            ...
            if (result.success) {
                ...
                if (errorNumber === Constants.errorSSLCertificateValidationFailed) {
                    self._connectionManager.showInstructionTextAsWarning(self._currentNode.connectionInfo, (updatedProfile) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        let fileUri = objectExplorerUtils_1.ObjectExplorerUtils.getNodeUri(self._currentNode);
                        if (yield self._connectionManager.connectionStore.saveProfile(updatedProfile)) {
                            const res = yield self._connectionManager.connect(fileUri, updatedProfile);
                            if (yield self._connectionManager.handleConnectionResult(res, fileUri, updatedProfile)) {
