...
export class DatabasesImpl {
    ...
    listMetricsPagingPage(resourceGroupName, serverName, databaseName, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingPage_1() {
            let result = yield __await(this._listMetrics(resourceGroupName, serverName, databaseName, filter, options));
    ...
    listMetricDefinitionsPagingPage(resourceGroupName, serverName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listMetricDefinitionsPagingPage_1() {
            let result = yield __await(this._listMetricDefinitions(resourceGroupName, serverName, databaseName, options));
            yield yield __await(result.value || []);
        });
    }
    ...
    listByElasticPoolPagingPage(resourceGroupName, serverName, elasticPoolName, options) {
        return __asyncGenerator(this, arguments, function* listByElasticPoolPagingPage_1() {
            let result = yield __await(this._listByElasticPool(resourceGroupName, serverName, elasticPoolName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listInaccessibleByServerPagingPage(resourceGroupName, serverName, options) {
        return __asyncGenerator(this, arguments, function* listInaccessibleByServerPagingPage_1() {
            let result = yield __await(this._listInaccessibleByServer(resourceGroupName, serverName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
