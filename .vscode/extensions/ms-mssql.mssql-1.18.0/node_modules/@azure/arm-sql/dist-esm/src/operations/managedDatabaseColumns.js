...
export class ManagedDatabaseColumnsImpl {
    ...
    listByDatabasePagingPage(resourceGroupName, managedInstanceName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listByDatabasePagingPage_1() {
            let result = yield __await(this._listByDatabase(resourceGroupName, managedInstanceName, databaseName, options));
    ...
    listByTablePagingPage(resourceGroupName, managedInstanceName, databaseName, schemaName, tableName, options) {
        return __asyncGenerator(this, arguments, function* listByTablePagingPage_1() {
            let result = yield __await(this._listByTable(resourceGroupName, managedInstanceName, databaseName, schemaName, tableName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
