...
export class ManagedInstanceOperationsImpl {
    ...
    get(resourceGroupName, managedInstanceName, operationId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, operationId, options }, getOperationSpec);
    }
    /**
    ...
    cancel(resourceGroupName, managedInstanceName, operationId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, operationId, options }, cancelOperationSpec);
    }
    /**
...
//# sourceMappingURL=managedInstanceOperations.js.map