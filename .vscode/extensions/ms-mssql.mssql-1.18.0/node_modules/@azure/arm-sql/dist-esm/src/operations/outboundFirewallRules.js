...
export class OutboundFirewallRulesImpl {
    /**
    ...
    get(resourceGroupName, serverName, outboundRuleFqdn, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, outboundRuleFqdn, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, serverName, outboundRuleFqdn, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, outboundRuleFqdn, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
//# sourceMappingURL=outboundFirewallRules.js.map