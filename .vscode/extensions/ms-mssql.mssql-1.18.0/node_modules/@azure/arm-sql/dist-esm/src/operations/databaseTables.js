...
export class DatabaseTablesImpl {
    /**
    ...
    listBySchemaPagingPage(resourceGroupName, serverName, databaseName, schemaName, options) {
        return __asyncGenerator(this, arguments, function* listBySchemaPagingPage_1() {
            let result = yield __await(this._listBySchema(resourceGroupName, serverName, databaseName, schemaName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listBySchemaNext(resourceGroupName, serverName, databaseName, schemaName, continuationToken, options));
    ...
    listBySchemaPagingAll(resourceGroupName, serverName, databaseName, schemaName, options) {
        return __asyncGenerator(this, arguments, function* listBySchemaPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listBySchemaPagingPage(resourceGroupName, serverName, databaseName, schemaName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
