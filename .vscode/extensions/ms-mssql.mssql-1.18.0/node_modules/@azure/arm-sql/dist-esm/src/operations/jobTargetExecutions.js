...
export class JobTargetExecutionsImpl {
    /**
    ...
    listByJobExecutionPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, options) {
        return __asyncGenerator(this, arguments, function* listByJobExecutionPagingPage_1() {
            let result = yield __await(this._listByJobExecution(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByJobExecutionNext(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, continuationToken, options));
    ...
    listByJobExecutionPagingAll(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, options) {
        return __asyncGenerator(this, arguments, function* listByJobExecutionPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByJobExecutionPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listByStepPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, options) {
        return __asyncGenerator(this, arguments, function* listByStepPagingPage_1() {
            let result = yield __await(this._listByStep(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByStepNext(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, continuationToken, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
    ...
    listByStepPagingAll(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, options) {
        return __asyncGenerator(this, arguments, function* listByStepPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listByStepPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
