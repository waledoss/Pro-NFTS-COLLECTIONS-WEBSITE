...
export class DatabaseSchemasImpl {
    /**
    ...
    get(resourceGroupName, serverName, databaseName, schemaName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, databaseName, schemaName, options }, getOperationSpec);
    }
    /**
     * ListByDatabaseNext
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
...
//# sourceMappingURL=databaseSchemas.js.map