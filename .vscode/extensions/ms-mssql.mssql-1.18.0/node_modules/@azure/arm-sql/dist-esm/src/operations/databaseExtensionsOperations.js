...
export class DatabaseExtensionsOperationsImpl {
    ...
    get(resourceGroupName, serverName, databaseName, extensionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, databaseName, extensionName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=databaseExtensionsOperations.js.map