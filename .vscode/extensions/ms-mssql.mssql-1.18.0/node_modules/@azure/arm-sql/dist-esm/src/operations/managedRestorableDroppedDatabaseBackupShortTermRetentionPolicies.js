...
export class ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesImpl {
    ...
    listByRestorableDroppedDatabasePagingPage(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, options) {
        return __asyncGenerator(this, arguments, function* listByRestorableDroppedDatabasePagingPage_1() {
            let result = yield __await(this._listByRestorableDroppedDatabase(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByRestorableDroppedDatabaseNext(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, continuationToken, options));
    ...
    listByRestorableDroppedDatabasePagingAll(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, options) {
        return __asyncGenerator(this, arguments, function* listByRestorableDroppedDatabasePagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByRestorableDroppedDatabasePagingPage(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=managedRestorableDroppedDatabaseBackupShortTermRetentionPolicies.js.map