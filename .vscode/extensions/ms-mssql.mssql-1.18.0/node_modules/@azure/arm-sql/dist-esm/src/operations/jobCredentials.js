...
export class JobCredentialsImpl {
    /**
    ...
    get(resourceGroupName, serverName, jobAgentName, credentialName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, jobAgentName, credentialName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, serverName, jobAgentName, credentialName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, jobAgentName, credentialName, options }, deleteOperationSpec);
    }
    /**
     * ListByAgentNext
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
