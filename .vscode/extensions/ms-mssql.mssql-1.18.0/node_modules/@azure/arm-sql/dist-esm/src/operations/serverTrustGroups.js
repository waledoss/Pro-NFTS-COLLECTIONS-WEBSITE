...
export class ServerTrustGroupsImpl {
    /**
    ...
    listByLocationPagingPage(resourceGroupName, locationName, options) {
        return __asyncGenerator(this, arguments, function* listByLocationPagingPage_1() {
            let result = yield __await(this._listByLocation(resourceGroupName, locationName, options));
    ...
    get(resourceGroupName, locationName, serverTrustGroupName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, locationName, serverTrustGroupName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, locationName, serverTrustGroupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, locationName, serverTrustGroupName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
//# sourceMappingURL=serverTrustGroups.js.map