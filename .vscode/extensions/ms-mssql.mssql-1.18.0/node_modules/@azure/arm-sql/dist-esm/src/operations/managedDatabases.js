...
export class ManagedDatabasesImpl {
    /**
    ...
    listByInstancePagingPage(resourceGroupName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listByInstancePagingPage_1() {
            let result = yield __await(this._listByInstance(resourceGroupName, managedInstanceName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByInstanceNext(resourceGroupName, managedInstanceName, continuationToken, options));
    ...
    listByInstancePagingAll(resourceGroupName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listByInstancePagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByInstancePagingPage(resourceGroupName, managedInstanceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listInaccessibleByInstancePagingPage(resourceGroupName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listInaccessibleByInstancePagingPage_1() {
            let result = yield __await(this._listInaccessibleByInstance(resourceGroupName, managedInstanceName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listInaccessibleByInstanceNext(resourceGroupName, managedInstanceName, continuationToken, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
    ...
    listInaccessibleByInstancePagingAll(resourceGroupName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listInaccessibleByInstancePagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listInaccessibleByInstancePagingPage(resourceGroupName, managedInstanceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    get(resourceGroupName, managedInstanceName, databaseName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, databaseName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, managedInstanceName, databaseName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, managedInstanceName, databaseName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
