...
export class ServerAzureADOnlyAuthenticationsImpl {
    ...
    get(resourceGroupName, serverName, authenticationName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, authenticationName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, serverName, authenticationName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, authenticationName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
//# sourceMappingURL=serverAzureADOnlyAuthentications.js.map