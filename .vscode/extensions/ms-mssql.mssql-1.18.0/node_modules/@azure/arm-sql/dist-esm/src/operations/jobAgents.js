...
export class JobAgentsImpl {
    ...
    get(resourceGroupName, serverName, jobAgentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, jobAgentName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, serverName, jobAgentName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, jobAgentName, parameters, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serverName, jobAgentName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, jobAgentName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    beginUpdate(resourceGroupName, serverName, jobAgentName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, jobAgentName, parameters, options }, updateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
