...
export class ManagedInstanceKeysImpl {
    /**
    ...
    get(resourceGroupName, managedInstanceName, keyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, keyName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, managedInstanceName, keyName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, managedInstanceName, keyName, parameters, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, managedInstanceName, keyName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, managedInstanceName, keyName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
