...
export class ManagedDatabaseSensitivityLabelsImpl {
    ...
    listCurrentByDatabasePagingPage(resourceGroupName, managedInstanceName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listCurrentByDatabasePagingPage_1() {
            let result = yield __await(this._listCurrentByDatabase(resourceGroupName, managedInstanceName, databaseName, options));
    ...
    listRecommendedByDatabasePagingPage(resourceGroupName, managedInstanceName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listRecommendedByDatabasePagingPage_1() {
            let result = yield __await(this._listRecommendedByDatabase(resourceGroupName, managedInstanceName, databaseName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
