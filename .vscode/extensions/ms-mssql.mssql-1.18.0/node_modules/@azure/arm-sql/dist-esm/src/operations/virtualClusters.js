...
export class VirtualClustersImpl {
    /**
    ...
    get(resourceGroupName, virtualClusterName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, virtualClusterName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, virtualClusterName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualClusterName, options }, deleteOperationSpec);
    ...
    beginUpdate(resourceGroupName, virtualClusterName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualClusterName, parameters, options }, updateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
//# sourceMappingURL=virtualClusters.js.map