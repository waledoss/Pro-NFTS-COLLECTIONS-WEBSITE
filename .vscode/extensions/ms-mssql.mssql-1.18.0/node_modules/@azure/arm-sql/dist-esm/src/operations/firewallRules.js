...
export class FirewallRulesImpl {
    /**
    ...
    createOrUpdate(resourceGroupName, serverName, firewallRuleName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, firewallRuleName, parameters, options }, createOrUpdateOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, serverName, firewallRuleName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, firewallRuleName, options }, deleteOperationSpec);
    }
    /**
     * Gets a list of firewall rules.
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
