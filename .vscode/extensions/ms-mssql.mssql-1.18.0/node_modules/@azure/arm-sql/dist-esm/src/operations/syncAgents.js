...
export class SyncAgentsImpl {
    ...
    listLinkedDatabasesPagingPage(resourceGroupName, serverName, syncAgentName, options) {
        return __asyncGenerator(this, arguments, function* listLinkedDatabasesPagingPage_1() {
            let result = yield __await(this._listLinkedDatabases(resourceGroupName, serverName, syncAgentName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listLinkedDatabasesNext(resourceGroupName, serverName, syncAgentName, continuationToken, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
    ...
    listLinkedDatabasesPagingAll(resourceGroupName, serverName, syncAgentName, options) {
        return __asyncGenerator(this, arguments, function* listLinkedDatabasesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listLinkedDatabasesPagingPage(resourceGroupName, serverName, syncAgentName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    get(resourceGroupName, serverName, syncAgentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, syncAgentName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, serverName, syncAgentName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, syncAgentName, parameters, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serverName, syncAgentName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, syncAgentName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
