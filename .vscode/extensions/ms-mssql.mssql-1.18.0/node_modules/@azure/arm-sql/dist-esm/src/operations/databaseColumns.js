...
export class DatabaseColumnsImpl {
    /**
    ...
    listByDatabasePagingPage(resourceGroupName, serverName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listByDatabasePagingPage_1() {
            let result = yield __await(this._listByDatabase(resourceGroupName, serverName, databaseName, options));
    ...
    listByTablePagingPage(resourceGroupName, serverName, databaseName, schemaName, tableName, options) {
        return __asyncGenerator(this, arguments, function* listByTablePagingPage_1() {
            let result = yield __await(this._listByTable(resourceGroupName, serverName, databaseName, schemaName, tableName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByTableNext(resourceGroupName, serverName, databaseName, schemaName, tableName, continuationToken, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
    ...
    listByTablePagingAll(resourceGroupName, serverName, databaseName, schemaName, tableName, options) {
        return __asyncGenerator(this, arguments, function* listByTablePagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listByTablePagingPage(resourceGroupName, serverName, databaseName, schemaName, tableName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
...
//# sourceMappingURL=databaseColumns.js.map