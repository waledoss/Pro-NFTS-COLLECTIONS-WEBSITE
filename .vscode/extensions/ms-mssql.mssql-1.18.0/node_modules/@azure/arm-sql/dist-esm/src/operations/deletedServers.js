...
export class DeletedServersImpl {
    /**
    ...
    get(locationName, deletedServerName, options) {
        return this.client.sendOperationRequest({ locationName, deletedServerName, options }, getOperationSpec);
    }
    /**
     * Gets a list of deleted servers for a location.
     * @param locationName The name of the region where the resource is located.
...
//# sourceMappingURL=deletedServers.js.map