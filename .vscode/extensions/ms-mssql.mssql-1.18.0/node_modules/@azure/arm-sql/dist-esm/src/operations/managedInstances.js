...
export class ManagedInstancesImpl {
    ...
    listByInstancePoolPagingPage(resourceGroupName, instancePoolName, options) {
        return __asyncGenerator(this, arguments, function* listByInstancePoolPagingPage_1() {
            let result = yield __await(this._listByInstancePool(resourceGroupName, instancePoolName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByInstancePoolNext(resourceGroupName, instancePoolName, continuationToken, options));
    ...
    listByInstancePoolPagingAll(resourceGroupName, instancePoolName, options) {
        return __asyncGenerator(this, arguments, function* listByInstancePoolPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByInstancePoolPagingPage(resourceGroupName, instancePoolName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listByManagedInstancePagingPage(resourceGroupName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listByManagedInstancePagingPage_1() {
            let result = yield __await(this._listByManagedInstance(resourceGroupName, managedInstanceName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByManagedInstanceNext(resourceGroupName, managedInstanceName, continuationToken, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
    ...
    listByManagedInstancePagingAll(resourceGroupName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listByManagedInstancePagingAll_1() {
            var e_4, _a;
            try {
                for (var _b = __asyncValues(this.listByManagedInstancePagingPage(resourceGroupName, managedInstanceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    get(resourceGroupName, managedInstanceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, managedInstanceName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, managedInstanceName, parameters, options }, createOrUpdateOperationSpec);
