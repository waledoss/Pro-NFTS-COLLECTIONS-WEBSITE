...
export class ServerDnsAliasesImpl {
    /**
    ...
    get(resourceGroupName, serverName, dnsAliasName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, dnsAliasName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, serverName, dnsAliasName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, dnsAliasName, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serverName, dnsAliasName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, dnsAliasName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
