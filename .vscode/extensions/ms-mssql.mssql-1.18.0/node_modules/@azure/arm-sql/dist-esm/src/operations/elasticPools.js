...
export class ElasticPoolsImpl {
    ...
    listMetricsPagingPage(resourceGroupName, serverName, elasticPoolName, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingPage_1() {
            let result = yield __await(this._listMetrics(resourceGroupName, serverName, elasticPoolName, filter, options));
    ...
    listMetricsPagingAll(resourceGroupName, serverName, elasticPoolName, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listMetricsPagingPage(resourceGroupName, serverName, elasticPoolName, filter, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listMetricDefinitionsPagingPage(resourceGroupName, serverName, elasticPoolName, options) {
        return __asyncGenerator(this, arguments, function* listMetricDefinitionsPagingPage_1() {
            let result = yield __await(this._listMetricDefinitions(resourceGroupName, serverName, elasticPoolName, options));
            yield yield __await(result.value || []);
        });
    }
    listMetricDefinitionsPagingAll(resourceGroupName, serverName, elasticPoolName, options) {
        return __asyncGenerator(this, arguments, function* listMetricDefinitionsPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listMetricDefinitionsPagingPage(resourceGroupName, serverName, elasticPoolName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    listByServerPagingPage(resourceGroupName, serverName, options) {
        return __asyncGenerator(this, arguments, function* listByServerPagingPage_1() {
            let result = yield __await(this._listByServer(resourceGroupName, serverName, options));
            yield yield __await(result.value || []);
    ...
    get(resourceGroupName, serverName, elasticPoolName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, elasticPoolName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, serverName, elasticPoolName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, elasticPoolName, parameters, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serverName, elasticPoolName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, elasticPoolName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    beginUpdate(resourceGroupName, serverName, elasticPoolName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, elasticPoolName, parameters, options }, updateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    beginFailover(resourceGroupName, serverName, elasticPoolName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, elasticPoolName, options }, failoverOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
