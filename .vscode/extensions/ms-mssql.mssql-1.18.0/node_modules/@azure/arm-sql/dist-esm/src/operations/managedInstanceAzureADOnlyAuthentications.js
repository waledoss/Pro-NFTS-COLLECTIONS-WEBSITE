...
export class ManagedInstanceAzureADOnlyAuthenticationsImpl {
    ...
    get(resourceGroupName, managedInstanceName, authenticationName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, authenticationName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, managedInstanceName, authenticationName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, managedInstanceName, authenticationName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
//# sourceMappingURL=managedInstanceAzureADOnlyAuthentications.js.map