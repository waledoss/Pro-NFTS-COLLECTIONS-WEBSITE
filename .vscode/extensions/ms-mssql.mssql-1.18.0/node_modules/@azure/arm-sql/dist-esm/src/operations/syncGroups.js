...
export class SyncGroupsImpl {
    ...
    listSyncDatabaseIdsPagingPage(locationName, options) {
        return __asyncGenerator(this, arguments, function* listSyncDatabaseIdsPagingPage_1() {
            let result = yield __await(this._listSyncDatabaseIds(locationName, options));
    ...
    listHubSchemasPagingPage(resourceGroupName, serverName, databaseName, syncGroupName, options) {
        return __asyncGenerator(this, arguments, function* listHubSchemasPagingPage_1() {
            let result = yield __await(this._listHubSchemas(resourceGroupName, serverName, databaseName, syncGroupName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listLogsPagingPage(resourceGroupName, serverName, databaseName, syncGroupName, startTime, endTime, typeParam, options) {
        return __asyncGenerator(this, arguments, function* listLogsPagingPage_1() {
            let result = yield __await(this._listLogs(resourceGroupName, serverName, databaseName, syncGroupName, startTime, endTime, typeParam, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listLogsNext(resourceGroupName, serverName, databaseName, syncGroupName, startTime, endTime, continuationToken, typeParam, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
