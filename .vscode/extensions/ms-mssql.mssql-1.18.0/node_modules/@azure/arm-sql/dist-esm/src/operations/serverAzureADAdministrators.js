...
export class ServerAzureADAdministratorsImpl {
    ...
    get(resourceGroupName, serverName, administratorName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, administratorName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, serverName, administratorName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, administratorName, parameters, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serverName, administratorName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, administratorName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
