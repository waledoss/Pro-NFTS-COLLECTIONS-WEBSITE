...
export class ServerDevOpsAuditSettingsImpl {
    ...
    get(resourceGroupName, serverName, devOpsAuditingSettingsName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, devOpsAuditingSettingsName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=serverDevOpsAuditSettings.js.map