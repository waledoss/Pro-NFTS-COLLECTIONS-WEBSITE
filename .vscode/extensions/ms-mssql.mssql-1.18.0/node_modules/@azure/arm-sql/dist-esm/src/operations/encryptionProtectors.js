...
export class EncryptionProtectorsImpl {
    /**
    ...
    get(resourceGroupName, serverName, encryptionProtectorName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, encryptionProtectorName, options }, getOperationSpec);
    }
    /**
