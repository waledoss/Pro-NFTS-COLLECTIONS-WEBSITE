...
export class ServerCommunicationLinksImpl {
    /**
    ...
    delete(resourceGroupName, serverName, communicationLinkName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, communicationLinkName, options }, deleteOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, serverName, communicationLinkName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, communicationLinkName, options }, getOperationSpec);
    }
    /**
