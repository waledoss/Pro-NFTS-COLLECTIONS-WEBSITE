...
export class ReplicationLinksImpl {
    /**
    ...
    delete(resourceGroupName, serverName, databaseName, linkId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, databaseName, linkId, options }, deleteOperationSpec);
    }
    /**
    ...
    beginFailover(resourceGroupName, serverName, databaseName, linkId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serverName, databaseName, linkId, options }, failoverOperationSpec);
    ...
    get(resourceGroupName, serverName, databaseName, linkId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, databaseName, linkId, options }, getOperationSpec);
    }
    /**
     * Gets a list of replication links.
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
