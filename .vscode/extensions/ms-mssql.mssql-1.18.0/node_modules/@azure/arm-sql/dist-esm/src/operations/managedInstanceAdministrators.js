...
export class ManagedInstanceAdministratorsImpl {
    ...
    get(resourceGroupName, managedInstanceName, administratorName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, administratorName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, managedInstanceName, administratorName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, managedInstanceName, administratorName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
//# sourceMappingURL=managedInstanceAdministrators.js.map