...
export class WorkloadClassifiersImpl {
    /**
    ...
    listByWorkloadGroupPagingPage(resourceGroupName, serverName, databaseName, workloadGroupName, options) {
        return __asyncGenerator(this, arguments, function* listByWorkloadGroupPagingPage_1() {
            let result = yield __await(this._listByWorkloadGroup(resourceGroupName, serverName, databaseName, workloadGroupName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByWorkloadGroupNext(resourceGroupName, serverName, databaseName, workloadGroupName, continuationToken, options));
    ...
    listByWorkloadGroupPagingAll(resourceGroupName, serverName, databaseName, workloadGroupName, options) {
        return __asyncGenerator(this, arguments, function* listByWorkloadGroupPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByWorkloadGroupPagingPage(resourceGroupName, serverName, databaseName, workloadGroupName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=workloadClassifiers.js.map