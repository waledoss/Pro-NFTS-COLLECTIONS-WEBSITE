...
export class SensitivityLabelsImpl {
    /**
    ...
    listCurrentByDatabasePagingPage(resourceGroupName, serverName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listCurrentByDatabasePagingPage_1() {
            let result = yield __await(this._listCurrentByDatabase(resourceGroupName, serverName, databaseName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listCurrentByDatabaseNext(resourceGroupName, serverName, databaseName, continuationToken, options));
    ...
    listCurrentByDatabasePagingAll(resourceGroupName, serverName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listCurrentByDatabasePagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listCurrentByDatabasePagingPage(resourceGroupName, serverName, databaseName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listRecommendedByDatabasePagingPage(resourceGroupName, serverName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listRecommendedByDatabasePagingPage_1() {
            let result = yield __await(this._listRecommendedByDatabase(resourceGroupName, serverName, databaseName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listRecommendedByDatabaseNext(resourceGroupName, serverName, databaseName, continuationToken, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
    ...
    listRecommendedByDatabasePagingAll(resourceGroupName, serverName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listRecommendedByDatabasePagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listRecommendedByDatabasePagingPage(resourceGroupName, serverName, databaseName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    update(resourceGroupName, serverName, databaseName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, databaseName, parameters, options }, updateOperationSpec);
    }
    /**
     * Gets the sensitivity labels of a given database
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
...
//# sourceMappingURL=sensitivityLabels.js.map