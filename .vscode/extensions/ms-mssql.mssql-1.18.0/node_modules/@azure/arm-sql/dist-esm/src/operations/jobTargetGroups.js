...
export class JobTargetGroupsImpl {
    /**
    ...
    listByAgentPagingPage(resourceGroupName, serverName, jobAgentName, options) {
        return __asyncGenerator(this, arguments, function* listByAgentPagingPage_1() {
            let result = yield __await(this._listByAgent(resourceGroupName, serverName, jobAgentName, options));
    ...
    get(resourceGroupName, serverName, jobAgentName, targetGroupName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, jobAgentName, targetGroupName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, serverName, jobAgentName, targetGroupName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, jobAgentName, targetGroupName, options }, deleteOperationSpec);
    }
    /**
     * ListByAgentNext
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
