...
export class ManagedDatabaseTablesImpl {
    /**
    ...
    listBySchemaPagingPage(resourceGroupName, managedInstanceName, databaseName, schemaName, options) {
        return __asyncGenerator(this, arguments, function* listBySchemaPagingPage_1() {
            let result = yield __await(this._listBySchema(resourceGroupName, managedInstanceName, databaseName, schemaName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listBySchemaNext(resourceGroupName, managedInstanceName, databaseName, schemaName, continuationToken, options));
    ...
    listBySchemaPagingAll(resourceGroupName, managedInstanceName, databaseName, schemaName, options) {
        return __asyncGenerator(this, arguments, function* listBySchemaPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listBySchemaPagingPage(resourceGroupName, managedInstanceName, databaseName, schemaName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=managedDatabaseTables.js.map