...
export class JobStepsImpl {
    ...
    listByVersionPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobVersion, options) {
        return __asyncGenerator(this, arguments, function* listByVersionPagingPage_1() {
            let result = yield __await(this._listByVersion(resourceGroupName, serverName, jobAgentName, jobName, jobVersion, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listByVersionNext(resourceGroupName, serverName, jobAgentName, jobName, jobVersion, continuationToken, options));
    ...
    listByVersionPagingAll(resourceGroupName, serverName, jobAgentName, jobName, jobVersion, options) {
        return __asyncGenerator(this, arguments, function* listByVersionPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByVersionPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobVersion, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listByJobPagingPage(resourceGroupName, serverName, jobAgentName, jobName, options) {
        return __asyncGenerator(this, arguments, function* listByJobPagingPage_1() {
            let result = yield __await(this._listByJob(resourceGroupName, serverName, jobAgentName, jobName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
