...
export class LongTermRetentionManagedInstanceBackupsImpl {
    ...
    listByDatabasePagingPage(locationName, managedInstanceName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listByDatabasePagingPage_1() {
            let result = yield __await(this._listByDatabase(locationName, managedInstanceName, databaseName, options));
    ...
    listByInstancePagingPage(locationName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listByInstancePagingPage_1() {
            let result = yield __await(this._listByInstance(locationName, managedInstanceName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listByResourceGroupDatabasePagingPage(resourceGroupName, locationName, managedInstanceName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listByResourceGroupDatabasePagingPage_1() {
            let result = yield __await(this._listByResourceGroupDatabase(resourceGroupName, locationName, managedInstanceName, databaseName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listByResourceGroupInstancePagingPage(resourceGroupName, locationName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listByResourceGroupInstancePagingPage_1() {
            let result = yield __await(this._listByResourceGroupInstance(resourceGroupName, locationName, managedInstanceName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
