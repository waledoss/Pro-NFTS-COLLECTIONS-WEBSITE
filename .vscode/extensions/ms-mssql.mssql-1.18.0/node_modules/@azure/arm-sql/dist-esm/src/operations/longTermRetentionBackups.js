...
export class LongTermRetentionBackupsImpl {
    ...
    listByDatabasePagingPage(locationName, longTermRetentionServerName, longTermRetentionDatabaseName, options) {
        return __asyncGenerator(this, arguments, function* listByDatabasePagingPage_1() {
            let result = yield __await(this._listByDatabase(locationName, longTermRetentionServerName, longTermRetentionDatabaseName, options));
    ...
    listByLocationPagingPage(locationName, options) {
        return __asyncGenerator(this, arguments, function* listByLocationPagingPage_1() {
            let result = yield __await(this._listByLocation(locationName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listByServerPagingPage(locationName, longTermRetentionServerName, options) {
        return __asyncGenerator(this, arguments, function* listByServerPagingPage_1() {
            let result = yield __await(this._listByServer(locationName, longTermRetentionServerName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listByResourceGroupDatabasePagingPage(resourceGroupName, locationName, longTermRetentionServerName, longTermRetentionDatabaseName, options) {
        return __asyncGenerator(this, arguments, function* listByResourceGroupDatabasePagingPage_1() {
            let result = yield __await(this._listByResourceGroupDatabase(resourceGroupName, locationName, longTermRetentionServerName, longTermRetentionDatabaseName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listByResourceGroupLocationPagingPage(resourceGroupName, locationName, options) {
        return __asyncGenerator(this, arguments, function* listByResourceGroupLocationPagingPage_1() {
            let result = yield __await(this._listByResourceGroupLocation(resourceGroupName, locationName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listByResourceGroupServerPagingPage(resourceGroupName, locationName, longTermRetentionServerName, options) {
        return __asyncGenerator(this, arguments, function* listByResourceGroupServerPagingPage_1() {
            let result = yield __await(this._listByResourceGroupServer(resourceGroupName, locationName, longTermRetentionServerName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
