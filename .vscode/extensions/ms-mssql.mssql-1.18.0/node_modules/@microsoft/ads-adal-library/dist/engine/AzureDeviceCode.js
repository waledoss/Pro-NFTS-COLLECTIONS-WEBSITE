    ...
    setupPolling(info) {
        ...
        return new Promise((resolve, reject) => {
            ...
            timeout = setTimeout(() => {
                clearInterval(timer);
                // Error when getting access token for DeviceCodeLogin
                reject(new AzureAuthError_1.AzureAuthError(errors_1.ErrorCodes.GetAccessTokenDeviceCodeLogin, this.errorLookup.getSimpleError(errors_1.ErrorCodes.GetAccessTokenDeviceCodeLogin)));
            }, fiveMinutes);
        });
    }
